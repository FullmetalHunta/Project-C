...
#include "JordanSimsCharacter.generated.h"
...
UCLASS(config = Game)
class AJordanSimsCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	TSubclassOf<class AJordanSimsProjectile> ProjectileClass;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Health")
		//sets up all the functionality for the health//
	...
	//sets the functionality for the magic//
